...
[![GitHub Release](https://img.shields.io/badge/Release-v1.3.2-blue)](https://github.com/Lrx121013/-AIP-AI-Player/releases/tag/v1.3.2)
...
### v1.3.2（2026-07-19）
- ✨ 新增 GUI 管理界面，按 **K 键**打开
- ✨ 支持 30+ 种游戏操作（坐下、睡觉、潜行、站立、挥手、跳舞等）
- ✨ 支持换皮肤（`playerskin:` 和 `skinurl:`）
- ✨ 离线模式：LLM 超时时自动执行本地行为
- 🐛 修复皮肤更换失败（`Property.getValue()` 反射拦截）
- 🐛 修复 NPC 无法移动问题
- 🐛 修复 LLM 超时导致行为重复
